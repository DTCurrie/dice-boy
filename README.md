...
**NOTE: Sorry, this bot is currently deprecated until it can be converted to slash commands. I plan on doing this, but am open for any PRs to start the process.**
